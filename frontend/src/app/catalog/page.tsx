      ...
      <header className="border-b border-slate-200/60 bg-white/80 backdrop-blur-md sticky top-0 z-40 px-8 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2.5 px-4.5 py-2.5 bg-slate-50 border border-slate-200 hover:border-indigo-550/20 text-slate-800 text-xs font-semibold rounded-xl shadow-sm transition-all duration-350 relative group cursor-pointer"
          >
        ...
        {filteredProducts.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 px-4 text-center bg-white border border-slate-200 rounded-3xl shadow-sm max-w-md mx-auto space-y-4">
            ...
            <button
              ...
              className="text-xs font-semibold py-2 px-4 border border-slate-200 rounded-xl hover:bg-slate-50 hover:text-slate-800 transition-colors cursor-pointer"
            >
              Reset Filters
            </button>
          </div>
                      ...
                      <button
                        ...
                        className={`px-4 py-2.5 text-xs font-semibold rounded-xl transition-all duration-300 flex items-center gap-1.5 shadow-md active:scale-95 cursor-pointer ${
                          isOutOfStock
                            ...
                            : "bg-indigo-600 hover:bg-indigo-750 text-white hover:shadow-lg hover:shadow-indigo-200/20"
                        }`}
                      >
