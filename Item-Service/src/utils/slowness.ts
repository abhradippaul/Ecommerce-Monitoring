 ...
 * - ENABLE_SLOWNESS / SIMULATE_SLOWNESS / ENABLE_TRAFFIC_SLOWNESS / ENABLE_ITEM_SLOWNESS: 'true' / 'false'
...
export const simulateSlowness = async (spanName: string = 'simulateTrafficSlowness') => {
  const isEnabled =
    ...
    process.env.ENABLE_ITEM_SLOWNESS === 'true' ||
    process.env.SIMULATE_ITEM_SLOWNESS === 'true';
